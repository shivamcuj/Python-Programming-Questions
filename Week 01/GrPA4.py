...
output2 = word1[0:4]+"-"+word2[len(word2)-4:len(word2)] # str: join first four letters of word1 and last four letters of word 2 with a hyphen "-" in between
...
has_h = word1.find("h")!=(-1) # bool: True if word1 has the letter h

ends_with_a = word1.endswith("a") or word1.endswith("A") # bool: True if word1 ends with letter a or A

has_the_word_python = sentence.find("python")!=-1 # bool: True if the sentence has the word python
